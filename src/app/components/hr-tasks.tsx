...
const initialTasks: Task[] = [
  { id: "1", title: "Review new hire documents", description: "Check and verify all onboarding paperwork", assignedTo: "Sarah Williams", dueDate: "2026-02-17", priority: "high", status: "pending", completion: 0, category: "daily" },
  { id: "2", title: "Update attendance records", description: "Process daily attendance for all employees", assignedTo: "You", dueDate: "2026-02-17", priority: "high", status: "in-progress", completion: 65, category: "daily" },
  { id: "3", title: "Approve leave requests", description: "Review pending leave applications", assignedTo: "You", dueDate: "2026-02-17", priority: "medium", status: "completed", completion: 100, category: "daily" },
  { id: "4", title: "Complete onboarding checklist", description: "Process new employee onboarding", assignedTo: "Sarah Williams", dueDate: "2026-02-20", priority: "high", status: "in-progress", completion: 75, category: "regular" },
  { id: "5", title: "Submit performance review", description: "Complete quarterly performance evaluation", assignedTo: "Michael Torres", dueDate: "2026-02-18", priority: "high", status: "completed", completion: 100, category: "regular" },
  { id: "6", title: "Update employee handbook", description: "Revise policies and procedures", assignedTo: "Jennifer Lee", dueDate: "2026-02-25", priority: "medium", status: "pending", completion: 0, category: "regular" },
  { id: "7", title: "Conduct team training", description: "Organize training session on new HR policies", assignedTo: "David Kim", dueDate: "2026-02-22", priority: "medium", status: "in-progress", completion: 45, category: "regular" },
  { id: "8", title: "Review salary adjustments", description: "Process salary increment requests", assignedTo: "Emma Johnson", dueDate: "2026-02-28", priority: "high", status: "pending", completion: 0, category: "regular" },
  { id: "9", title: "Send daily HR report", description: "Compile and send daily HR metrics", assignedTo: "You", dueDate: "2026-02-17", priority: "medium", status: "completed", completion: 100, category: "daily" },
];
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-3xl font-bold gradient-text">HR Tasks</h2>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <span className="text-[#5A4079]">HR Manager</span>
                    </div>
                  </div>
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 text-sm">
